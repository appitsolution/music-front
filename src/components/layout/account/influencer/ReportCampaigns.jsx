        ...
        <div className="report-block">
          ...
          <div className="report-info">
            ...
            <div className="report-info-item">
              <p className="report-info-text">
                Brand:
                <span className="report-info-text-span">{company.company}</span>
              </p>
              <p className="report-info-text">
                Date Requested:{" "}
                {dataPromo
                  ? formatDateStringReport(dataPromo.dateRequest)
                  : "No Date"}
              </p>
            </div>
          </div>
                    ...
                    <div className="report-mobile-item-info">
                      ...
                      <div className="report-mobile-item-info-video">
                        <a
                          ...
                          href={item.video ? item.video : ""}
                        >
                          {" "}
                          {item.video ? item.video : "No Date"}
                        </a>
